        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="form-material m-t-40" method="POST" action="{{route('news.store')}}" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                <textarea class="textarea_editor form-control" rows="15" placeholder="" name="content" id="content">{{old('content')}}</textarea>
                            </div>
                        </div>
                        {{--<div class="form-group">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="button-group">
                                    ...
                                    <button type="submit" class="btn waves-effect waves-light btn-outline-info">Создать новость</button>
                                </div>
                            </div>
                        </div>
                    </form>
